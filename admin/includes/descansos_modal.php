    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="descansos_add.php">
...
<div class="modal fade " id="edit">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="descansos_edit.php">
                    <input type="hidden" class="caid" name="id">
                    <div class="form-group">
                        <label for="dias" class="col-sm-3 control-label">dias</label>

                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="diass" name="diass" required>
                        </div>
                    </div>
            </div>
            <div class="modal-footer">
...
<div class="modal fade" id="delete">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal" method="POST" action="descansos_delete.php">
                    <input type="hidden" class="caid" name="id">
                    <div class="text-center">
                        <p>Eliminar Descansos?</p>
