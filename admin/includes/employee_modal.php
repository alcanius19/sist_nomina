      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="employee_add.php" enctype="multipart/form-data">
          <div class="form-group">
            <label for="id_employe" class="col-sm-3 control-label">Id_empleado</label>

            <div class="col-sm-9">
              <input type="text" class="form-control" id="id_employe" name="id_employe" required>
            </div>
          </div>

          <div class="form-group">
            <label for="salario_base" class="col-sm-3 control-label">Salario Base</label>
          ...
          <div class="form-group">
            <label for="identification" class="col-sm-3 control-label">Identificacion</label>

            <div class="col-sm-9">
              <input class="form-control" name="identification"></textarea>
            </div>
          </div>
      ...
      <div class="modal-body">
        <form class="form-horizontal" method="POST" action="employee_edit.php">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <input type="text" class="form-control" id="salario" name="salario_base">
            </div>
          </div>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-9">
              <textarea class="form-control" name="identification" id="identification"></textarea>
            </div>
          </div>
