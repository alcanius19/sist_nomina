<aside class="main-sidebar">
  ...
  <section class="sidebar">
    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li><a href="horas.php"><i class="fa fa-clock-o"></i> <span>Horas</span></a></li>
      <li class="treeview">
        <a href="#">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="incapacidad.php"><i class="fa fa-circle-o"></i> Incapacidad</a></li>
          <li><a href="otros.php"><i class="fa fa-circle-o"></i>Otros</a></li>
          <li><a href="descansos.php"><i class="fa fa-circle-o"></i>Descansos</a></li>
