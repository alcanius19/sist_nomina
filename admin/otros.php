...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
          ...
          ";
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="box">
                            ...
                            <div class="box-body">
                                <table id="example1" class="table table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        $sql = "SELECT *, otros.id AS caid, employees.employee_id AS empid FROM otros LEFT JOIN employees ON employees.id=otros.employee_id ORDER BY fecha_otro DESC";
                        ...
                        <tr>
                          <td class='hidden'></td>
                          <td>" . date('M d, Y', strtotime($row['fecha_otro'])) . "</td>
                          <td>" . $row['empid'] . "</td>
        ...
        <?php include 'includes/otros_modal.php'; ?>
    </div>
