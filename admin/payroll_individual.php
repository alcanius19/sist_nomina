...
while ($row = $query->fetch_assoc()) {
	...
	$suma = $row['neto'] + $pagos_descansos + $incapacidad + $otros  - $total_deduction;
	$subtotal = $row['neto'];

	$total_pagar = ($suma);
	// $porcentaje = ($row['neto'] + $pagos_descansos - $total_deduction) * 0.08;
	...
	$contents .= '
			...
			<table cellspacing="0" cellpadding="3">  
				...
				<tr> 
    	    		...
    	    		<td></td> 
    	    		<td></td>
				 	<td width="25%" align="right"><b>Dias Trabajados: </b></td>
				...
				<tr> 
    	    		...
    	    		<td></td>
				 	...
				 	<td width="25%" align="right"><b>' . number_format($subtotal, 2) . '</b></td> 
    	    	</tr>
...
$asistencia = "SELECT * FROM attendance  WHERE date BETWEEN '$from' AND '$to' AND employee_id = '$id'  ";
...
while ($data = $ejecute->fetch_assoc()) {
 ...
 <td width="100" align="center"><b>' . $data['date'] . '</b></td>
  ...
  <td width="100" align="center"><b>' . $data['total'] . '</b></td>
