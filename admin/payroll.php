              ...
              <div class="box-header with-border">
                <div class="pull-right">
                  <form method="POST" class="form-inline" id="payForm">
                    ...
                    <button type="button" class="btn btn-success btn-sm btn-flat" id="excel"><span class="glyphicon glyphicon-download"></span>Excel</button>
                  </form>
                </div>
              </div>
              <div class="box-body">
                    ...
                    while ($row = $query->fetch_assoc()) {
                      ...
                      echo "
                        <tr>
                          ...
                          <td>" . '<button type="button" class="btn btn-primary pdf" data-dismiss="alert" aria-hidden="true" " value=' . $empid . '>pdf</button>' . "</td>
                        </tr>
                      ";
                    }
  ...
  <script>
    $(function() {
      ...
      $("#example1").on("click", ".pdf", function(e) {
        ...
        let valor = $(this).val();
        console.log(valor);
        $('#payForm').attr('action', 'payroll_individual.php?id=' + valor);
        $('#payForm').submit();
      });
      ...
      $('#excel').click(function(e) {
        e.preventDefault();
        $('#payForm').attr('action', 'nomina_excel.php');
        $('#payForm').submit();
      });
