...
<body class="hold-transition fondo">
    <div class="container">
        <div class="padre">
            ...
            <a href="index.php" class='boton'>Registrar ingreso</a>
        </div>
        <div class="row">
        </div>
    </div>
        ...
        <div class="login-box-body">
            ...
            <form id="attendance_noc">
                ...
                <div class="form-group has-feedback">
                    <input type="number" class="form-control input-lg" id="employee" name="employee" required>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#attendance_noc').submit(function(e) {
                e.preventDefault();
                console.log("diste click");
                var attendance_noc = $(this).serialize();
                $.ajax({
                    type: 'POST',
                    url: 'attendance_noc.php',
                    data: attendance_noc,
                    dataType: 'json',
